...
El combate puede sacar a tu Agente del juego rápida y permanentemente. No lo tomes a la ligera.

### **Una Acción por Turno**

El combate se resuelve por turnos. Cada turno dura típicamente unos segundos, aunque puede representar solo una fracción de segundo de violencia.  

Cada personaje actúa una vez por turno. El personaje con **DEX** más alto actúa primero, luego el siguiente más alto, y así hasta que todos hayan actuado.

Cuando sea tu turno, elige una acción:
...
- **Cualquier Otra Acción:** Cualquier cosa que requiera un momento de concentración.
...
- Permite que tu Agente se esconda tras cobertura para evadir ataques a distancia (la cobertura debe estar a ~3 m).
    
- Esquivar protege contra cada ataque que superes en la tirada.
...
- No protege contra ataques a distancia a menos que tu Agente interfiera físicamente con el arma.
    
- Al contraatacar, elige una acción ofensiva: atacar, disparo dirigido, desarmar o inmovilizar.
    
- Si tu tirada supera el ataque, la acción del atacante no tiene efecto y tu acción afecta al atacante.
    
- Mientras la tirada defiende contra todos los atacantes, la acción ofensiva afecta solo a un objetivo.
